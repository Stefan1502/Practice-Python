...
# player_1 = [int(el) - 1 for el in input("col,row: ").split(',')]
# player_2 = [int(el) - 1 for el in input("col,row: ").split(',')]


while True:
    player_1 = [int(el) - 1 for el in input("p1, col,row: ").split(',')]
    if game[player_1[0]][player_1[1]] != 'x' or 'O':
        game[player_1[0]][player_1[1]] = 'x'
    player_2 = [int(el) - 1 for el in input("p2, col,row: ").split(',')]
    game[player_2[0]][player_2[1]] = 'O'
    print(game)
